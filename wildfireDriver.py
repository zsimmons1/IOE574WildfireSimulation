...
# 'spread_prob' is a 3D matrix containing the probability of fire spread for each cell from each neighboring cell
    # from the previous time step
# spread_prob = np.zeros((np.size(map, 1), np.size(map, 2), 8), dtype=float)    
